...
def render(df_base: Optional[pd.DataFrame] = None, caminho_banco: str | None = None) -> None:
    ...
    st.markdown(
        f"<div style='font-size:1.1rem;font-weight:700;margin:6px 0 10px;'>Ano selecionado: {ano} • Total no ano (parcelas): <span style='color:#00C853;'>{_fmt_moeda_str(total_ano)}</span></div>",
